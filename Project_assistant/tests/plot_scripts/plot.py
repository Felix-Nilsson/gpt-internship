...
def plot():
    positive = pd.read_csv("Project_assistant/tests/results/data/positive_results.csv")
    negative = pd.read_csv("Project_assistant/tests/results/data/negative_results.csv")
    ...
    plt.savefig("Project_assistant/tests/results/plots/similarity.png")