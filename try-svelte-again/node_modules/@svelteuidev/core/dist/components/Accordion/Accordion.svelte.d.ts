...
import type { AccordionEvents as $$AccordionEvents } from './Accordion';
declare const __propDef: {
    props: {
        class?: string;
        variant?: import("./Accordion").AccordionVariant;
        value?: string | string[];
        ...
        loop?: boolean;
        id?: string;
        chevron?: HTMLOrSVGElement | typeof import("svelte").SvelteComponent;
    ...
    events: $$AccordionEvents<Multiple>;
};
