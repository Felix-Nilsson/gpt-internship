...
def boxplot():
    ...
    pos_emb = pd.read_csv("Project3_intranet/tests/results/data/positive_results.csv")
    neg_emb = pd.read_csv("Project3_intranet/tests/results/data/negative_results.csv")
