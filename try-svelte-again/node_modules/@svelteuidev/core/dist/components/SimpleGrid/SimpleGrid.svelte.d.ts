...
declare const __propDef: {
    props: {
        class?: string;
        breakpoints?: import("./SimpleGrid").SimpleGridBreakpoint[];
        cols?: number;
...
export type SimpleGridProps = typeof __propDef.props;
export type SimpleGridEvents = typeof __propDef.events;
export type SimpleGridSlots = typeof __propDef.slots;
/**
 ...
 * ```
 */
export default class SimpleGrid extends SvelteComponentTyped<SimpleGridProps, SimpleGridEvents, SimpleGridSlots> {
}
export {};
