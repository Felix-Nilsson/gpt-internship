...
export type CheckboxIconProps = typeof __propDef.props;
export type CheckboxIconEvents = typeof __propDef.events;
export type CheckboxIconSlots = typeof __propDef.slots;
export default class CheckboxIcon extends SvelteComponentTyped<CheckboxIconProps, CheckboxIconEvents, CheckboxIconSlots> {
}
export {};
