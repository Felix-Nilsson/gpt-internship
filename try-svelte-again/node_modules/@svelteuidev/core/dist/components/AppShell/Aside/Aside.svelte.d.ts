...
declare const __propDef: {
    props: {
        ...
        fixed?: boolean;
        position?: import("../HorizontalSection/HorizontalSection").HorizontalSectionPosition;
        hiddenBreakpoint?: import("../../..").SvelteUINumberSize;
        hidden?: boolean;
        zIndex?: number;
        className?: string;
        override?: import("../../..").CSS;
...
export default class Aside extends SvelteComponentTyped<AsideProps, AsideEvents, AsideSlots> {
}
export {};
