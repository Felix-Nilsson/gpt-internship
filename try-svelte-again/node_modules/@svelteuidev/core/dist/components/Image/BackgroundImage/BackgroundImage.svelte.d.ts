...
declare const __propDef: {
    props: {
        class?: string;
        src?: string;
        overridePlaceholder?: import("../../..").CSS;
        radius?: import("../../..").SvelteUINumberSize;
        fit?: import("../Image").ImageFit;
        width?: string | number;
        ...
        srcset?: string;
        usemap?: string;
        'bind:naturalWidth'?: number;
        'bind:naturalHeight'?: number;
        accesskey?: string;
        autofocus?: boolean;
...
export type BackgroundImageProps = typeof __propDef.props;
export type BackgroundImageEvents = typeof __propDef.events;
export type BackgroundImageSlots = typeof __propDef.slots;
/**
 ...
 */
export default class BackgroundImage extends SvelteComponentTyped<BackgroundImageProps, BackgroundImageEvents, BackgroundImageSlots> {
}
export {};
