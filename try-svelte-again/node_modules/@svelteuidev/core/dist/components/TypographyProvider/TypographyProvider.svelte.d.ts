...
declare const __propDef: {
    props: {
        class?: string;
        underline?: boolean;
        primaryColor?: import("../..").SvelteUIColor;
        className?: string;
        override?: import("../..").CSS;
        element?: HTMLElement;
...
export type TypographyProviderProps = typeof __propDef.props;
export type TypographyProviderEvents = typeof __propDef.events;
export type TypographyProviderSlots = typeof __propDef.slots;
export default class TypographyProvider extends SvelteComponentTyped<TypographyProviderProps, TypographyProviderEvents, TypographyProviderSlots> {
}
export {};
