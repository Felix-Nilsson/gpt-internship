<!-- TAKEN AND MODIFIED FROM https://svelte.dev/repl/a1c9e4be23d746ddba6b7d62d4aad875?version=3.35.0 -->
...
<script>
    ...
    <div role="radiogroup" class="group-container" style="font-size:{fontSize}px;">
        <Title order={5} variant='gradient' gradient={{from: 'blue', to: 'red', deg: 45}} style="line-height:1.5">{legend}</Title>
