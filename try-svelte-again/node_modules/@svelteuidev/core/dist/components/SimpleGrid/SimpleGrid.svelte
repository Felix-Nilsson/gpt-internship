...
export let use = [], element = undefined, className = '', override = {}, breakpoints = [], cols = 1, spacing = 'md';
...
$: ({ cx, classes, getStyles } = useStyles({ cols, spacing, gridBreakpoints }, { name: 'SimpleGrid' }));
</script>
