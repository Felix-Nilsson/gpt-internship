...
export type OptionalPortalProps = typeof __propDef.props;
export type OptionalPortalEvents = typeof __propDef.events;
export type OptionalPortalSlots = typeof __propDef.slots;
export default class OptionalPortal extends SvelteComponentTyped<OptionalPortalProps, OptionalPortalEvents, OptionalPortalSlots> {
}
export {};
